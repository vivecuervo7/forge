...
|---|---|---|---|
| `chunk complete` | driver → curator | a meaningful chunk is done — read my trace and curate it. Sent the moment the chunk lands, before the next begins | `summary="chunk complete: <intent>"` · `message="<invoked X \| drove fresh: …> · <bypass reason?> · <taught gotcha?> · Look at my trace."` |
