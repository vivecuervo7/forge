...
Two coordination channels have their own protocol files and aren't repeated here:
...
| signal | direction | meaning | shape |
|---|---|---|---|
| completion ping | teammate → lead | my task is done — here's the result | `summary="<role> task complete"` · `message="… proposals: <N>. Going idle."` |
