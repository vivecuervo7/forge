...
allowed-tools: Read, Edit, Write, Glob, Grep, Skill, AskUserQuestion, Bash(node **/scripts/forge-*), Bash(direnv:*), Bash(mkdir:*), Bash(cat:*), Bash(echo:*), Bash(ls:*), Bash(mv:*), Bash(tmux:*), Bash(**/forge/node_modules/.bin/esbuild *), Agent, SendMessage, TaskCreate, TaskList, TaskGet, TaskUpdate
---
